import{i as e,l as t,t as n}from"./lit-Cbk7b9dC.js";import{a as r,c as i,i as a,o,s}from"./wui-text--7Jisbxi.js";import{C as c,D as l,E as u,F as d,L as f,N as ee,P as p,S as m,T as te,_ as h,a as g,b as _,c as v,d as y,h as b,i as ne,l as x,n as S,r as re,t as C,v as ie,w as ae,x as w,y as T}from"./ConstantsUtil-DZnLjTHw.js";import{t as E}from"./SIWXUtil-CyQIHuuQ.js";var D=d({message:``,open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:`shade`}),O=te({state:D,subscribe(e){return f(D,()=>e(D))},subscribeKey(e,t){return p(D,e,t)},showTooltip({message:e,triggerRect:t,variant:n}){D.open=!0,D.message=e,D.triggerRect=t,D.variant=n},hide(){D.open=!1,D.message=``,D.triggerRect={width:0,height:0,top:0,left:0}}}),k={isUnsupportedChainView(){return T.state.view===`UnsupportedChain`||T.state.view===`SwitchNetwork`&&T.state.history.includes(`UnsupportedChain`)},async safeClose(){if(this.isUnsupportedChainView()){v.shake();return}if(await E.isSIWXCloseDisabled()){v.shake();return}v.close()}},oe=t`
  :host {
    display: block;
